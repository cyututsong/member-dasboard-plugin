        ...
        <tbody>
            <?php if (!empty($entries)): ?>
                <?php foreach ($entries as $entry): ?>
                    <tr>
                        <td><?php echo esc_html(rgar($entry, $name_field_id)); ?></td>
                        <td><?php echo esc_html(rgar($entry, $email_field_id)); ?></td>
                        <td><?php echo esc_html(rgar($entry, $phone_field_id)); ?></td>
                        <td><?php echo esc_html(rgar($entry, $presence_field_id)); ?></td>
                        <td>
                            <?php
...
add_action('wp_enqueue_scripts', function() {
    ...
    wp_localize_script('gf-entries-ajax', 'gfEntriesAjax', [
